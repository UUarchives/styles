...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
	...
	two columns. -->
			<body>
				<style type="text/css">p, body {font-family: arial}</style>
			...
			<!--If you do not want to include an image, delete the center
				...
				<center>
					<a href="http://www.uu.edu"><img src="http://www.uu.edu/images/2015/uu_icon-35.png"/></a>
				</center>
	...
	<h3 style="text-align:center">
		...
		<p style="text-align:center">
			<a href="http://guides.uu.edu/archives"><xsl:value-of select="filedesc/publicationstmt/publisher"/></a><br/>
			<xsl:for-each select="filedesc/publicationstmt/address/addressline">
				<xsl:choose>
...
<!-- The next two templates format an arrangement
	...
	<xsl:template mode="direct" match="archdesc/controlaccess">
		<h3><xsl:text>Subject Terms</xsl:text></h3>
